...
// ── Sumi Ink Reveal for NEBU STUDIO ─────────────────────────────────────────
...
const SumiReveal = () => {
  ...
  useEffect(() => {
    ...
    if (!wasVisible.current) {
      ...
      // Re-entry: mini sweep + underline pulse only
      setReEntry(true);
  ...
  // Organic wavy brush-stroke paths
  ...
  // Underline breathing animation (after complete + on re-entry)
    ...
    >
      ...
      <div className="flex justify-center overflow-hidden" style={{ lineHeight: 1 }}>
        <div
          ...
          style={{ fontSize: "clamp(3.2rem, 10.5vw, 8.5rem)", lineHeight: 1.05 }}
        >
          {/* Ghost base — always readable */}
          <span
            className="font-display block whitespace-nowrap"
            style={{ color: "hsl(var(--foreground) / 0.28)", letterSpacing: "-0.01em" }}
            aria-hidden="true"
          >
            NEBU STUDIO
          </span>

          {/* Ink-filled overlay — left-to-right width reveal */}
          <motion.div
          ...
          >
            <span
              className="font-display block whitespace-nowrap"
              style={{ color: "hsl(var(--foreground) / 0.93)", letterSpacing: "-0.01em" }}
            >
              NEBU STUDIO
            </span>
          </motion.div>

          {/* Cinematic light sweep — triggers at phase 2 */}
          <AnimatePresence>
            {phase === 2 && (
              <motion.div
                key="sweep-first"
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "linear-gradient(108deg, transparent 15%, hsl(0 0% 100% / 0.13) 48%, hsl(0 0% 100% / 0.06) 55%, transparent 80%)",
                  }}
                  initial={{ left: "-42%" }}
                  animate={{ left: "145%" }}
            ...
            {reEntry && (
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "linear-gradient(108deg, transparent 15%, hsl(0 0% 100% / 0.08) 50%, transparent 80%)",
                  }}
                  initial={{ left: "-35%" }}
                  animate={{ left: "135%" }}
            ...
            {hoverShimmer && (
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "linear-gradient(108deg, transparent 10%, hsl(0 0% 100% / 0.09) 50%, transparent 80%)",
                  }}
                  initial={{ left: "5%" }}
                  animate={{ left: "75%" }}
      ...
      {/* Red watercolor brush underline */}
      <div className="flex justify-center" style={{ marginTop: "-0.35em" }}>
        <svg
          viewBox="0 0 600 22"
          className="w-full overflow-visible"
          style={{ maxWidth: "min(90%, 820px)", height: "auto" }}
          aria-hidden="true"
        >
          ...
          <motion.path
            ...
            animate={
              phase >= 3
                ? { pathLength: 1, opacity: underlineBreath ? 0.88 : 0.74 }
