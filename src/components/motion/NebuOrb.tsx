            ...
            >
              ...
              <div className="px-5 pb-5 flex flex-col gap-2">
                <a
                  href="#contact"
                  onClick={() => setIsOpen(false)}
                  className="group flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all"
                  style={{
                ...
                >
                  ...
                  <span className="flex-1">WhatsApp us</span>
                  <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform opacity-60" />
                </a>
              </div>
            </motion.div>
          </>
